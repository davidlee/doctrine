...
**reproduced from forgettable's frozen `GitContextFrameV1`, byte-for-byte**, not
...
golden-vector that pins us to forgettable lands the moment capture exists.
...
- **No shared crate (D7).** forgettable is a separate workspace + daemon; we
