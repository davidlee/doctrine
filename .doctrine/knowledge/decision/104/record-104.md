# DEC-104: Capsule admission reuses conflict semantics only

Supersedes [[capsule-admission-derived-commit]] (DEC-100), which solved the
...
the derivation stage disappears and DEC-100's F3 finding ("no belted
