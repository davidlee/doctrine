# QUE-185: Minimum mechanically enforced design-stage gates

<!-- Knowledge record body — context, detail, links. The structured, queried
     fields live in the sister `record-NNN.toml`; this prose is free-form and is
     never structurally parsed (the storage rule). -->

Which transitions among `exploring`, `inquiring`, `drafting`, `reviewing`, and
`locked` require mechanical evidence, and which sequencing should remain agent
