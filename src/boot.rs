...
/// Optional user-authored footer injected after the Memory section, before the
/// build-volatile Invoking doctrine line. Absent → renders a benign marker.
/// The user controls the full body text — use it to tell agents to read specific
/// memories or any session-start instructions.
