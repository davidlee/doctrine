...
fn this_repos_revision_tree_is_tracked() {
    ...
    assert!(
        ...
        "this repo's authored revision tree must be tracked (git ls-files .doctrine/revision is empty)"
    );
}
